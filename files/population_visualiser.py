...
class PopulationVisualizer:
    def __init__(self):
        ...
        self.koala_img = pygame.image.load('files/images/koala.png')
        self.koala_sigma = pygame.image.load('files/images/sigma_koala.png')
        self.dead_koala_img = pygame.image.load('files/images/dead_koala.png')
        self.the_end_img = pygame.image.load('files/images/the_end.jpeg')
        self.background_image = pygame.image.load("files/images/background.jpeg").convert()
        self.background_end_image = pygame.image.load("files/images/tlo.jpeg").convert()
        self.background_phy_image = pygame.image.load("files/images/tlo_wykresy.jpeg").convert_alpha()
        self.meteor_image = pygame.image.load("files/images/meteor.webp").convert_alpha()
        self.chart_image = pygame.image.load("files/images/wykresy.jpeg").convert()
        self.koala_charts = pygame.image.load("files/images/koala_charts.jpeg")
        ...
        self.font = pygame.font.Font("files/fonts/czcionka.ttf", 13)
        ...
        self.explosion = pygame.mixer.Sound("files/sounds/explosion.mp3")
    ...
    def update_plot(self, population, opt_genotype, old_genotype, nr, is_dead, how_big):
        ...
        self.screen.blit(pygame.transform.scale(self.koala_charts, (600, 600)), (600, 0))
    ...
    def the_end(self, population, ancestral_population, nr, env_gen, env_pop_num, env_avg_gen, env_avg_fitted_gen, env_std):
        ...
        while True:
            ...
            if self.play_again_button.collidepoint(mouse_pos):
                ...
                chart_img = pygame.transform.scale(self.chart_image, (1024, 1024))
                charts = True
                while charts:
                    for event in pygame.event.get():
                        if event.type == pygame.QUIT:
